...
const points = [
    ...
    { no: 29, id: "동악산(곡성)", done: { step: false, date: "" }, pos_0: { y: 35.26132431, x: 127.2406651 }, info: { peak: "시루봉", height: 737.1 } },
    ...
    { no: 88, id: "칠보산(괴산)", done: { step: 20, date: "2025.05.17." }, pos_0: { y: 36.739981, x: 127.92771 }, info: { peak: "정상", height: 778 } },
