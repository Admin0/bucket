...
const points = [
    ...
    { no: 3, id: "가야산(경상)", done: { step: false, date: "" }, pos_0: { y: 35.822563, x: 128.122518 }, info: { peak: "우두봉", height: 1430 } },
    {
        no: 4,
        id: "가야산(충남)",
        done: { step: 8, date: "2025.02.02." },
        pos_0: { y: 36.7066361111, x: 126.6083527778 },
        info: { peak: "정상", height: 678.2 },
    },
    { no: 5, id: "가지산", done: { step: false, date: "" }, pos_0: { y: 35.619875, x: 129.003523 }, info: { peak: "정상", height: 1240 } },

    {
        no: 6,
        id: "감악산(원주)",
        done: { step: 36, date: "2025.09.13." },
        pos_0: { y: 37.233333, x: 128.316667 },
        info: { peak: "정상", height: 930 },
    },
    {
        no: 7,
        id: "감악산(파주)",
        done: { step: 28, date: "2025.06.21." },
        pos_0: { y: 37.941082, x: 126.969989 },
        info: { peak: "정상", height: 675 },
    },
    {
        no: 8,
        id: "계룡산",
        done: { step: 10, date: "2025.03.30." },
        pos_0: { y: 36.361424, x: 127.210292 },
        info: { peak: "관음봉", height: 845 },
    },
...

    {
        no: 11,
        id: "광덕산",
        done: { step: 1, date: "2024.10.27." },
        pos_0: { y: 36.687795, x: 127.027906 },
        info: { peak: "정상", height: 699.3 },
    },
    {
        no: 12,
        id: "구병산(보은)",
        done: { step: 22, date: "2025.05.24." },
        pos_0: { y: 36.46989438, x: 127.8625301 },
        info: { peak: "정상", height: 877 },
    },
    {
        no: 13,
        id: "구봉산(진안)",
        done: { step: 32, date: "2025.08.08." },
        pos_0: { y: 35.923157, x: 127.416559 },
        info: { peak: "천왕봉", height: 1002 },
    },
    { no: 14, id: "금수산", done: { step: false, date: "" }, pos_0: { y: 36.985009, x: 128.256761 }, info: { peak: "정상", height: 1016 } },
    { no: 15, id: "금오산(구미)", done: { step: false, date: "" }, pos_0: { y: 36.092833, x: 128.300054 }, info: { peak: "현월봉", height: 977 } },

    {
        no: 16,
        id: "금정산",
        done: { step: 14, date: "2025.04.26." },
        pos_0: { y: 35.280118, x: 129.050542 },
        info: { peak: "고당봉", height: 802 },
    },
    {
        no: 17,
        id: "남산(경주)",
        done: { step: 15, date: "2025.04.26." },
        pos_0: { y: 35.767661, x: 129.225369 },
        info: { peak: "금오봉", height: 468 },
    },
    {
        no: 18,
        id: "내변산(변산)",
        done: { step: 11, date: "2025.04.11." },
        pos_0: { y: 35.616667, x: 126.583333 },
        info: { peak: "관음봉", height: 424 },
    },
    { no: 19, id: "내연산", done: { step: false, date: "" }, pos_0: { y: 36.263301, x: 129.258523 }, info: { peak: "삼지봉", height: 710 } },
    {
        no: 20,
        id: "내장산",
        done: { step: 7, date: "2025.01.25." },
        pos_0: { y: 35.478299, x: 126.888994 },
        info: { peak: "신선봉", height: 763 },
    },

    { no: 21, id: "달마산", done: { step: false, date: "" }, pos_0: { y: 34.382545, x: 126.585159 }, info: { peak: "달마봉", height: 498.8 } },
    {
        no: 22,
        id: "대둔산",
        done: { step: 13, date: "2025.04.13." },
        pos_0: { y: 36.126556, x: 127.323071 },
        info: { peak: "마천대", height: 878 },
    },
    { no: 23, id: "대야산", done: { step: false, date: "" }, pos_0: { y: 36.649026, x: 127.96407 }, info: { peak: "정상", height: 931 } },
    { no: 24, id: "덕룡산", done: { step: false, date: "" }, pos_0: { y: 34.5379361111, x: 126.6983111111 }, info: { peak: "서봉", height: 432.8 } },
    ...
    { no: 28, id: "도봉산", done: { step: 25, date: "2025.05.31." }, pos_0: { y: 37.69883, x: 127.01547 }, info: { peak: "신선대", height: 740 } },
    {
        ...
        pos_0: { y: 35.26132431, x: 127.2406651 },
        info: { peak: "시루봉", height: 737.1 },
    },
    { no: 30, id: "두륜산", done: { step: false, date: "" }, pos_0: { y: 34.471848, x: 126.637535 }, info: { peak: "가련봉", height: 703 } },

    { no: 31, id: "두타산", done: { step: false, date: "" }, pos_0: { y: 37.43445721, x: 128.9734669 }, info: { peak: "정상", height: 1353 } },
    {
        no: 32,
        id: "마니산(강화도)",
        done: { step: 29, date: "2025.06.21." },
        pos_0: { y: 37.612745, x: 126.436401 },
        info: { peak: "정상", height: 469 },
    },
    {
        no: 33,
        id: "마이산(진안)",
        done: { step: 16, date: "2025.05.04." },
        pos_0: { y: 35.760484, x: 127.411233 },
        info: { peak: "비룡대", height: 686 },
    },
...

    {
        no: 36,
        id: "무등산",
        done: { step: 34, date: "2025.08.22." },
        pos_0: { y: 35.121098, x: 127.00283 },
    ...
    { no: 43, id: "백운산(동강)", done: { step: false, date: "" }, pos_0: { y: 37.29869, x: 128.579145 }, info: { peak: "정상", height: 883 } },
    {
        no: 44,
        id: "북한산",
        done: { step: 24, date: "2025.05.30." },
        pos_0: { y: 37.658657, x: 126.978056 },
        info: { peak: "백운대", height: 837 },
    },
    {
        no: 45,
        id: "불갑산(영광)",
    ...
    { no: 47, id: "삼악산", done: { step: false, date: "" }, pos_0: { y: 37.920351, x: 127.612711 }, info: { peak: "용화봉", height: 654 } },
    {
        no: 48,
        id: "선운산",
        done: { step: 27, date: "2025.06.08." },
        pos_0: { y: 35.517657, x: 126.577097 },
        info: { peak: "수리봉", height: 336 },
    },
    { no: 49, id: "설악산", done: { step: false, date: "" }, pos_0: { y: 38.119135, x: 128.46544 }, info: { peak: "한계령", height: 1708 } },
    { no: 50, id: "소백산", done: { step: false, date: "" }, pos_0: { y: 36.95786818, x: 128.4788661 }, info: { peak: "비로봉", height: 1439 } },

    {
        no: 51,
        id: "소요산",
        done: { step: 30, date: "2025.06.21." },
        pos_0: { y: 37.915914, x: 127.132813 },
        info: { peak: "의상대", height: 587 },
    },
    {
        no: 52,
        id: "속리산",
        done: { step: 21, date: "2025.05.23." },
        pos_0: { y: 36.543181, x: 127.870846 },
        info: { peak: "천황봉", height: 1057 },
    },
    {
        no: 53,
        id: "수락산",
        done: { step: 26, date: "2025.05.31." },
        pos_0: { y: 37.697923, x: 127.081283 },
        info: { peak: "주봉", height: 640.6 },
    },
    { no: 54, id: "신불산", done: { step: false, date: "" }, pos_0: { y: 35.53933, x: 129.053953 }, info: { peak: "정상", height: 1209 } },
    { no: 55, id: "연인산", done: { step: false, date: "" }, pos_0: { y: 37.898788, x: 127.41435 }, info: { peak: "정상", height: 1068 } },

    { no: 56, id: "오대산", done: { step: false, date: "" }, pos_0: { y: 37.785712, x: 128.637514 }, info: { peak: "노인봉", height: 1563 } },
    { no: 57, id: "오대산", done: { step: false, date: "" }, pos_0: { y: 37.797038, x: 128.544074 }, info: { peak: "비로봉", height: 1563 } },
    { no: 58, id: "오봉산", done: { step: false, date: "" }, pos_0: { y: 38.00002881, x: 127.807132 }, info: { peak: "정상", height: 779 } },
    {
        no: 59,
        id: "오서산",
        done: { step: 2, date: "2024.11.03." },
        pos_0: { y: 36.460056, x: 126.658811 },
        info: { peak: "정상", height: 789.9 },
    },
...

    {
        no: 61,
        id: "용봉산",
        done: { step: 6, date: "2025.01.19." },
        pos_0: { y: 36.6436555556, x: 126.6492388889 },
        info: { peak: "정상", height: 381 },
    },
    ...
    { no: 63, id: "운악산", done: { step: false, date: "" }, pos_0: { y: 37.878718, x: 127.322893 }, info: { peak: "서봉", height: 936 } },
    {
        no: 64,
        id: "운장산",
        done: { step: 33, date: "2025.08.08." },
        pos_0: { y: 35.915653, x: 127.363019 },
        info: { peak: "운장대", height: 1126 },
    },
    {
        no: 65,
        id: "월악산",
        done: { step: 5, date: "2025.01.12." },
        pos_0: { y: 36.886045, x: 128.105844 },
        info: { peak: "영봉", height: 1094 },
    },
    ...
    { no: 71, id: "조계산", done: { step: false, date: "" }, pos_0: { y: 35.001211, x: 127.313555 }, info: { peak: "장군봉", height: 884 } },
    { no: 72, id: "조령산", done: { step: false, date: "" }, pos_0: { y: 36.77083, x: 128.043553 }, info: { peak: "정상", height: 1027 } },
    { no: 73, id: "주왕산", done: { step: false, date: "" }, pos_0: { y: 36.389337, x: 129.162417 }, info: { peak: "주봉", height: 721 } },
    ...
    { no: 76, id: "지리산", done: { step: false, date: "" }, pos_0: { y: 35.421872, x: 127.576094 }, info: { peak: "바래봉", height: 1165 } },
    ...
    { no: 80, id: "천성산", done: { step: false, date: "" }, pos_0: { y: 35.378184, x: 128.950771 }, info: { peak: "비로봉", height: 922 } },
    ...
    { no: 84, id: "청화산", done: { step: false, date: "" }, pos_0: { y: 36.416667, x: 129.083333 }, info: { peak: "정상", height: 970 } },
    { no: 85, id: "축령산", done: { step: false, date: "" }, pos_0: { y: 37.752705, x: 127.333923 }, info: { peak: "정상", height: 879 } },

    {
        no: 86,
        id: "치악산",
        done: { step: 3, date: "2024.12.22." },
        pos_0: { y: 37.365077, x: 128.055568 },
        info: { peak: "비로봉", height: 1288 },
    },
    {
        no: 87,
        id: "칠갑산(청양)",
        done: { step: 9, date: "2025.02.23." },
        pos_0: { y: 36.413006, x: 126.884905 },
        info: { peak: "정상", height: 561 },
    },
    {
        no: 88,
        id: "칠보산(괴산)",
        done: { step: 20, date: "2025.05.17." },
        pos_0: { y: 36.739981, x: 127.92771 },
        info: { peak: "정상", height: 778 },
    },
...

    {
        no: 91,
        id: "팔공산",
        done: { step: 35, date: "2025.08.29." },
        pos_0: { y: 36.016137, x: 128.694901 },
        info: { peak: "비로봉", height: 1193 },
    },
    ...
    { no: 93, id: "팔영산", done: { step: false, date: "" }, pos_0: { y: 34.624358, x: 127.430924 }, info: { peak: "깃대봉", height: 609 } },
    {
        no: 94,
        id: "한라산",
        done: { step: 4, date: "2024.12.29." },
        pos_0: { y: 33.361578, x: 126.535756 },
        info: { peak: "백록담", height: 1950 },
    },
    { no: 95, id: "함백산", done: { step: false, date: "" }, pos_0: { y: 34.916667, x: 127.666667 }, info: { peak: "정상", height: 532 } },
    ...
    { no: 99, id: "황석산", done: { step: false, date: "" }, pos_0: { y: 35.730696, x: 127.761191 }, info: { peak: "정상", height: 1190 } },
