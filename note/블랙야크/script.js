...
const points = [
    ...
    { no: 1, id: "가리산(홍천)", done: false, pos_0: { y: 37.871353, x: 127.956485 }, info: { peak: "정상", height: 1051 } },
    { no: 2, id: "가리왕산", done: false, pos_0: { y: 37.460995, x: 128.56275 }, info: { peak: "정상", height: 1561 } },
    { no: 3, id: "가야산(경상)", done: false, pos_0: { y: 35.822563, x: 128.122518 }, info: { peak: "우두봉", height: 1430 } },
    { no: 4, id: "가야산(충남)", done: "2025.02.02.", pos_0: { y: 36.7066361111, x: 126.6083527778 }, info: { peak: "정상", height: 678.2 } },
    { no: 5, id: "가지산", done: false, pos_0: { y: 35.619875, x: 129.003523 }, info: { peak: "정상", height: 1240 } },

    { no: 6, id: "감악산(원주)", done: false, pos_0: { y: 37.233333, x: 128.316667 }, info: { peak: "정상", height: 675 } },
    { no: 7, id: "감악산(파주)", done: "2025.06.21.", pos_0: { y: 37.941082, x: 126.969989 }, info: { peak: "정상", height: 675 } },
    ...
    { no: 21, id: "달마산", done: false, pos_0: { y: 34.382545, x: 126.585159 }, info: { peak: "달마봉", height: 498.8 } },
    { no: 22, id: "대둔산", done: "2025.04.13.", pos_0: { y: 36.126556, x: 127.323071 }, info: { peak: "마천대", height: 878 } },
    { no: 23, id: "대야산", done: false, pos_0: { y: 36.649026, x: 127.96407 }, info: { peak: "정상", height: 931 } },
    { no: 24, id: "덕룡산", done: false, pos_0: { y: 34.5379361111, x: 126.6983111111 }, info: { peak: "서봉", height: 432.8 } },
    { no: 25, id: "덕유산", done: false, pos_0: { y: 35.85990274, x: 127.746381 }, info: { peak: "향적봉", height: 1614 } },

    { no: 26, id: "덕항산", done: false, pos_0: { y: 37.318296, x: 129.001612 }, info: { peak: "정상", height: 1071 } },
    { no: 27, id: "도락산", done: false, pos_0: { y: 36.856368, x: 128.311091 }, info: { peak: "정상", height: 964 } },
    { no: 28, id: "도봉산", done: "2025.05.31.", pos_0: { y: 37.69883, x: 127.01547 }, info: { peak: "신선대", height: 740 } },
    { no: 29, id: "동악산(곡성)", done: false, pos_0: { y: 35.26132431, x: 127.2406651 }, info: { peak: "시루봉", height: 737.1 } },
    { no: 30, id: "두륜산", done: false, pos_0: { y: 34.471848, x: 126.637535 }, info: { peak: "가련봉", height: 703 } },

    { no: 31, id: "두타산", done: false, pos_0: { y: 37.43445721, x: 128.9734669 }, info: { peak: "정상", height: 1353 } },
    { no: 32, id: "마니산(강화도)", done: "2025.06.21.", pos_0: { y: 37.612745, x: 126.436401 }, info: { peak: "정상", height: 469 } },
    ...
    { no: 36, id: "무등산", done: false, pos_0: { y: 35.121098, x: 127.00283 }, info: { peak: "인왕봉", height: 1187 } },
    { no: 37, id: "민주지산", done: false, pos_0: { y: 36.03976612, x: 127.849333 }, info: { peak: "정상", height: 1242 } },
    { no: 38, id: "방장산", done: false, pos_0: { y: 35.455991, x: 126.75431 }, info: { peak: "정상", height: 743 } },
    { no: 39, id: "방태산", done: false, pos_0: { y: 37.888141, x: 128.390341 }, info: { peak: "주억봉", height: 1444 } },
    { no: 40, id: "백덕산", done: false, pos_0: { y: 37.396072, x: 128.293787 }, info: { peak: "정상", height: 1350 } },

    { no: 41, id: "백암산", done: false, pos_0: { y: 35.461171, x: 126.868349 }, info: { peak: "상왕봉", height: 741 } },
    { no: 42, id: "백운산(광양)", done: false, pos_0: { y: 35.106243, x: 127.621757 }, info: { peak: "상봉", height: 1218 } },
    { no: 43, id: "백운산(동강)", done: false, pos_0: { y: 37.29869, x: 128.579145 }, info: { peak: "정상", height: 883 } },
    { no: 44, id: "북한산", done: "2025.05.30.", pos_0: { y: 37.658657, x: 126.978056 }, info: { peak: "백운대", height: 837 } },
    { no: 45, id: "불갑산(영광)", done: false, pos_0: { y: 35.1908333333, x: 126.5650472222 }, info: { peak: "연실봉", height: 517.7 } },

    { no: 46, id: "비슬산", done: false, pos_0: { y: 35.71526, x: 128.523981 }, info: { peak: "천왕봉", height: 1084 } },
    { no: 47, id: "삼악산", done: false, pos_0: { y: 37.920351, x: 127.612711 }, info: { peak: "용화봉", height: 654 } },
    { no: 48, id: "선운산", done: "2025.06.08.", pos_0: { y: 35.517657, x: 126.577097 }, info: { peak: "수리봉", height: 336 } },
    { no: 49, id: "설악산", done: false, pos_0: { y: 38.119135, x: 128.46544 }, info: { peak: "한계령", height: 1708 } },
    { no: 50, id: "소백산", done: false, pos_0: { y: 36.95786818, x: 128.4788661 }, info: { peak: "비로봉", height: 1439 } },

    { no: 51, id: "소요산", done: "2025.06.21.", pos_0: { y: 37.915914, x: 127.132813 }, info: { peak: "의상대", height: 587 } },
    { no: 52, id: "속리산", done: "2025.05.23.", pos_0: { y: 36.543181, x: 127.870846 }, info: { peak: "천황봉", height: 1057 } },
    { no: 53, id: "수락산", done: "2025.05.31.", pos_0: { y: 37.697923, x: 127.081283 }, info: { peak: "주봉", height: 640.6 } },
    { no: 54, id: "신불산", done: false, pos_0: { y: 35.53933, x: 129.053953 }, info: { peak: "정상", height: 1209 } },
    { no: 55, id: "연인산", done: false, pos_0: { y: 37.898788, x: 127.41435 }, info: { peak: "정상", height: 1068 } },

    { no: 56, id: "오대산", done: false, pos_0: { y: 37.785712, x: 128.637514 }, info: { peak: "노인봉", height: 1563 } },
    { no: 57, id: "오대산", done: false, pos_0: { y: 37.797038, x: 128.544074 }, info: { peak: "비로봉", height: 1563 } },
    { no: 58, id: "오봉산", done: false, pos_0: { y: 38.00002881, x: 127.807132 }, info: { peak: "정상", height: 779 } },
    { no: 59, id: "오서산", done: "2024.11.03.", pos_0: { y: 36.460056, x: 126.658811 }, info: { peak: "정상", height: 789.9 } },
    { no: 60, id: "용문산", done: false, pos_0: { y: 37.561979, x: 127.549637 }, info: { peak: "가섭봉", height: 1157 } },
    ...
    { no: 67, id: "유명산", done: false, pos_0: { y: 37.575285, x: 127.48662 }, info: { peak: "정상", height: 862 } },
    { no: 68, id: "응봉산", done: false, pos_0: { y: 37.076597, x: 129.230461 }, info: { peak: "정상", height: 999 } },
    { no: 69, id: "장안산", done: false, pos_0: { y: 35.625733, x: 127.593443 }, info: { peak: "정상", height: 1237 } },
    ...
    { no: 91, id: "팔공산", done: false, pos_0: { y: 36.016137, x: 128.694901 }, info: { peak: "비로봉", height: 1193 } },
    { no: 92, id: "팔봉산", done: false, pos_0: { y: 37.696514, x: 127.695577 }, info: { peak: "2봉", height: 302 } },
    { no: 93, id: "팔영산", done: false, pos_0: { y: 34.624358, x: 127.430924 }, info: { peak: "깃대봉", height: 609 } },
    { no: 94, id: "한라산", done: "2024.12.29.", pos_0: { y: 33.361578, x: 126.535756 }, info: { peak: "백록담", height: 1950 } },
    { no: 95, id: "함백산", done: false, pos_0: { y: 34.916667, x: 127.666667 }, info: { peak: "정상", height: 532 } },

    { no: 96, id: "화악산", done: false, pos_0: { y: 37.988856, x: 127.497655 }, info: { peak: "중봉", height: 1468 } },
    { no: 97, id: "화왕산", done: false, pos_0: { y: 35.547141, x: 128.531682 }, info: { peak: "정상", height: 757 } },
    { no: 98, id: "황매산", done: false, pos_0: { y: 35.495206, x: 127.974455 }, info: { peak: "정상", height: 1108 } },
    { no: 99, id: "황석산", done: false, pos_0: { y: 35.730696, x: 127.761191 }, info: { peak: "정상", height: 1190 } },
    { no: 100, id: "황악산", done: false, pos_0: { y: 36.117593, x: 127.966881 }, info: { peak: "정상", height: 1111 } },
];
...
function getImagePath(point) {
    return `/note/블랙야크/img/${point.no} ${point.id}.jpg`;
}
...
async function updateTitle(p, point) {
    ...
    if (point.done) {
        ...
        const exists = await isImageExists(imagePath);
        if (exists) {
            title = `<img style='margin-bottom:.5em;' src='${imagePath}'> ${title} <br/> ${point.done}`;
        } else {
